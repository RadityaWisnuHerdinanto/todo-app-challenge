  ...
  <div class="hidden md:grid md:grid-cols-[200px_1fr] lg:grid-cols-[250px_1fr] h-screen bg-gray-50">
    ...
    <aside class="bg-white border-r border-gray-200 flex flex-col">
      ...
      <div class="px-4 py-4 border-b border-gray-200">
        <h1 class="text-lg font-bold text-gray-900">Todo</h1>
      </div>

      <!-- Navigation -->
      <nav class="flex-1 px-3 py-4 space-y-2">
        <router-link to="/dashboard" class="flex items-center gap-3 px-3 py-2 rounded-md text-sm hover:bg-gray-100" active-class="bg-blue-50 text-primary font-semibold">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
          </svg>
          <span>Dashboard</span>
        </router-link>
        <router-link to="/tasks" class="flex items-center gap-3 px-3 py-2 rounded-md text-sm hover:bg-gray-100" active-class="bg-blue-50 text-primary font-semibold">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div class="px-3 py-4 border-t border-gray-200 space-y-2">
        ...
        <button @click="handleLogout" class="w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-100">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
