<!-- Desktop Layout -->
<template>
  <div class="hidden lg:grid lg:grid-cols-[280px_1fr] h-screen bg-gray-50">
    <!-- Full Sidebar -->
    <aside class="bg-white border-r border-gray-200 flex flex-col shadow-sm">
      <!-- Logo / Branding -->
      <div class="px-6 py-6 border-b border-gray-200">
        <h1 class="text-2xl font-bold text-gray-900">TaskHub</h1>
      ...
      <nav class="flex-1 px-3 py-6 space-y-3">
        <div class="space-y-1">
          ...
          <router-link to="/dashboard" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition" active-class="bg-blue-50 text-primary">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
            </svg>
            <span>Dashboard</span>
          </router-link>
          <router-link to="/tasks" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition" active-class="bg-blue-50 text-primary">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div class="px-3 py-6 border-t border-gray-200 space-y-4">
        ...
        <button @click="handleLogout" class="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 transition">
