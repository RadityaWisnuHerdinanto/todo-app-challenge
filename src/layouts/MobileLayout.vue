  ...
  <div class="flex flex-col h-screen bg-gray-50">
    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 md:hidden">
      <div class="flex justify-around items-center h-16">
        <router-link to="/dashboard" class="flex flex-col items-center justify-center h-full flex-1 text-xs gap-1 text-gray-600 transition hover:text-blue-600" active-class="text-blue-600 font-semibold">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
          </svg>
          <span>Home</span>
        </router-link>
        <router-link to="/tasks" class="flex flex-col items-center justify-center h-full flex-1 text-xs gap-1 text-gray-600 transition hover:text-blue-600" active-class="text-blue-600 font-semibold">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <button @click="handleLogout" class="flex flex-col items-center justify-center h-full flex-1 text-xs gap-1 text-gray-600 hover:text-red-600 transition">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
